Instance: CapabilityStatementTWNHIBASEServer
InstanceOf: CapabilityStatement
Usage: #definition
* url = "https://nhicore.nhi.gov.tw/base/CapabilityStatement/CapabilityStatementTWNHIBASEServer"
* version = "0.0.1"
* name = "CapabilityStatementTWNHIBASEServer"
* title = "臺灣健保署基礎-伺服端(TWNHIBASE Server)"
* status = #active
* experimental = false
...
* description = "臺灣健保署基礎實作指引(TWNHIBASE IG)伺服端(Server)之能力聲明"
* rest.mode = #server
* rest.documentation = "臺灣健保署基礎-伺服端(TWNHIBASE Server)必須(SHALL)：(1)支援本實作指引中所有profiles (2)根據FHIR規範實作RESTful (3)回傳狀態碼-①(Status 400)：無效參數(invalid parameter)、②(Status 401/4xx)：未經授權的請求(unauthorized request)、③(Status 403)：未充分授權的資料存取範圍(insufficient premission scope)、④(Status 404)：未知的resource(unknown resource) (4)支援JSON格式 (5)可識別每個新增到Server的實例(instance)之meta.profile是否為臺灣健保署基礎Profiles Defining URL，並確認實例是否依循Profile製作。臺灣健保署基礎-伺服端建議應該(SHOULD)：(1)支援XML格式。"
...
* rest.resource[=].profile[0] = "https://nhicore.nhi.gov.tw/base/StructureDefinition/Observation-diagnostic-twnhibase"
* rest.resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest.resource[=].interaction[=].extension.valueCode = #SHOULD
* rest.resource[=].interaction[=].code = #create
* rest.resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    <h2 id=\"title\">臺灣健保署基礎-伺服端(TWNHIBASE Server)</h2>
    <ul>
        <li>實作指引版本：0.0.1</li>
        <li>FHIR版本：4.0.1</li>
    ...
    <div class=\"panel panel-default\">
        ...
        <div class=\"panel-body\">
            <div>
                <p>臺灣健保署基礎-伺服端(TWNHIBASE Server)<b>必須(SHALL)</b>：<br/>
                    ...
                    (5)可識別每個新增到Server的實例（instance）之meta.profile是否為TWNHIBASE Profiles Defining
                    URL，並確認實例是否依循Profile製作。<br/>【註：實例是指依據Profile實作，將真實資料以JSON、XML或Turtle格式存放的檔案】</p>
                    <p>臺灣健保署基礎-伺服端(TWNHIBASE Server)<b>建議應該(SHOULD)</b>：<br/>
