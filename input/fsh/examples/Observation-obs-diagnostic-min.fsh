...
InstanceOf: ObservationDiagnosticTWNHIBASE
Title: "基因資訊"
Description: "依據基因資訊-Observation Diagnostic TWNHIBASE Profile呈現基因資訊之範例"
Usage: #example
* status = http://hl7.org/fhir/observation-status#final
* code.coding = http://loinc.org#69548-6
* category = https://nhicore.nhi.gov.tw/base/CodeSystem/nhi-supporting-info-type#geneInfo
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
    <div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\">
        <p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-Observation-diagnostic-twnhibase.html\">基因資訊-Observation Diagnostic TWNHIBASE</a></p>
    </div>
    <p><b>狀態</b>：final</p>
