...
InstanceOf: OrganizationTWNHIBASE
Title: "醫事機構"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
  ...
  <div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\">
    <p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-Organization-twnhibase.html\">機構-Organization TWNHIBASE</a></p>
  </div>
  <p>
    <b>機構名稱</b>：臺北市立聯合醫院
  </p>
  <p>
    ...
    <b>機構代碼（official）</b>：0101090517 (https://nhicore.nhi.gov.tw/base/CodeSystem/organization-identifier-tw)
  </p>
  <p>
...
InstanceOf: OrganizationGeneTWNHIBASE
Title: "基因檢測機構"
...
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\">
  ...
  <div style=\"display: inline-block; background-color: #d9e0e7; padding: 6px; margin: 4px; border: 1px solid #8da1b4; border-radius: 5px; line-height: 60%\">
    <p style=\"margin-bottom: 0px\">Profile: <a href=\"StructureDefinition-Organization-gene-twnhibase.html\">基因檢測機構-Organization Genetic Testing TWNHIBASE</a></p>
  </div>
  <p>
