Profile:        ObservationDiagnosticTWNHIBASE
Parent:         Observation
...
* category  1..1
* category.coding  1..1
* category.coding.system = "https://nhicore.nhi.gov.tw/base/CodeSystem/nhi-supporting-info-type"
...
* performer 1..1 MS
* performer only Reference(OrganizationGeneTWNHIBASE)
* subject only Reference(PatientTWNHIBASE)
* subject 1.. MS
* specimen 1..1 MS
* specimen only Reference(SpecimenTWNHIBASE)
* method 1..1 MS
...
* derivedFrom MS
* derivedFrom only Reference(DocumentReferenceTWNHIBASE)
